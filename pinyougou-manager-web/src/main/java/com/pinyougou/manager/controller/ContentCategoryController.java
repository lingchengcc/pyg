...
public class ContentCategoryController {
    ...
    public PageInfo<ContentCategory> findPage(@RequestParam(value = "pageNo", defaultValue = "1") Integer pageNo,
    ...
    public ContentCategory findOne(@PathVariable(value = "id") Long id) {
